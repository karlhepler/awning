...
- `RADAR_VETO_CLOUD_PCT` - Clear-sky veto: rain-bearing (max of low/mid layer) cloud cover % ceiling that, together with `RADAR_VETO_DNI_WM2`, suppresses a false radar rain signal; high cirrus is excluded (default: 15)
